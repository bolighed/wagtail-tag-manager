...
/***/ "./frontend/admin/widgets/codearea.scss":
/*!**********************************************!*\
  !*** ./frontend/admin/widgets/codearea.scss ***!
  \**********************************************/
...
/***/ "./frontend/admin/widgets/codearea.ts":
/*!********************************************!*\
  !*** ./frontend/admin/widgets/codearea.ts ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _codearea_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./codearea.scss */ "./frontend/admin/widgets/codearea.scss");
/* harmony import */ var _codearea_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_codearea_scss__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! codemirror/mode/django/django */ "./node_modules/codemirror/mode/django/django.js");
/* harmony import */ var codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_django_django__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! codemirror/addon/display/panel */ "./node_modules/codemirror/addon/display/panel.js");
/* harmony import */ var codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_display_panel__WEBPACK_IMPORTED_MODULE_3__);




var Codearea = /** @class */ (function () {
    function Codearea(el) {
        this.el = el;
        this.initialize();
    }
    Codearea.prototype.initialize = function () {
        var _this = this;
        this.editor = codemirror__WEBPACK_IMPORTED_MODULE_1__["fromTextArea"](this.el, { mode: "django" });
        fetch("/wtm/variables/")
    ...
    Codearea.prototype.addPanel = function (data) {
        var _this = this;
        var panelEl = document.createElement("ul");
        ...
        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
            ...
            for (var _a = 0, _b = group.items; _a < _b.length; _a++) {
                ...
                a.addEventListener("click", function (event) {
                    ...
                    _this.editor.doc.replaceSelection("{{ " + target.dataset.key + " }}", "end");
                    _this.editor.focus();
                });
...
window.wtm.initCodearea = function (selector, currentScript) {
...
/***/ 5:
/*!**************************************************!*\
  !*** multi ./frontend/admin/widgets/codearea.ts ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./frontend/admin/widgets/codearea.ts */"./frontend/admin/widgets/codearea.ts");


/***/ })

/******/ });
//# sourceMappingURL=sourcemaps/codearea.bundle.js.map